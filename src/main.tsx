    ...
    <HeroUIProvider>
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-7xl mx-auto bg-white rounded-xl shadow-lg p-8 relative">
          ...
          <div id="menu" className="flex gap-1 mb-6 border-b border-gray-200">
            {([
              ...
              <button
                ...
                className={`px-6 py-3 text-base font-semibold rounded-t-lg origin-bottom
          ...
          <div id="visualize" className={activeTab === 'visualize' ? '' : 'hidden'}>
            <SoundVisualizer />
          </div>

          <div id="chords" className={`flex gap-12 ${activeTab === 'chords' ? '' : 'hidden'}`}>
              {/* Left Panel */}
